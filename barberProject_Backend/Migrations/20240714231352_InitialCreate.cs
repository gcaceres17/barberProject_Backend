        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BarberModelId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reservations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Reservations_Barbers_BarberModelId",
                        column: x => x.BarberModelId,
                        principalTable: "Barbers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Reservations_Services_BarberId",
                        column: x => x.BarberId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_BarberModelId",
                table: "Reservations",
                column: "BarberModelId");
